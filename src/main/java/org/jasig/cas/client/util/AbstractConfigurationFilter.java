...
public abstract class AbstractConfigurationFilter implements Filter {
    ...
    protected final String getPropertyFromInitParams(final FilterConfig filterConfig, final String propertyName,
        ...
        // 增加从配置文件cas.properties中读取参数。
        final String value5 =  CasClientConfig.getProperty(propertyName, defaultValue);
        
        if (CommonUtils.isNotBlank(value5)) {
            logger.info("Property [{}] loaded from cas.properties with value [{}]", propertyName,
            		value5);
            return value5;
        }
